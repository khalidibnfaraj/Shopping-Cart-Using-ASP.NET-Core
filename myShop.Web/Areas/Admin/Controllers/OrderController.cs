...
namespace myshop.Web.Areas.Admin.Controllers
{
	...
	public class OrderController : Controller
	{
		...
		public IActionResult GetData()
		{
			...
			orderHeaders = _unitofwork.OrderHeader.GetAll(includeValue: "ApplicationUser");
		...
		public IActionResult Details(int orderid)
		{
			...
			{
				OrderHeader = _unitofwork.OrderHeader.GetFirstOrDefault(u => u.Id == orderid, includeValue: "ApplicationUser"),
				OrderDetails = _unitofwork.OrderDetails.GetAll(x => x.OrderHeaderId == orderid, includeValue: "Product")
			};
